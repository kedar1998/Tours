...
function App() {
  const item = [
    ...
    },
    {
      ...
      price: "$2,695",
      imgurl:"https://dl.airtable.com/.attachments/27f6cbfe631e303f98b97e9dafacf25b/6bbe2a07/vienna.jpeg",
      content:
  ...
  const removeItem = (key) =>{
    setItems(items.filter((ind) => ind.id !== key));
    
  }

  return (
    <div className="mt-5 px-4">
      <h2 className="text-2xl md:text-4xl font-bold text-center underline underline-offset-4 decoration-cyan-400 mb-5">
        Our Tours
      </h2>
      <div className="flex items-center justify-center">
        <Cards item={items} removeItem={removeItem}/>
      </div>
    </div>
  );
}
